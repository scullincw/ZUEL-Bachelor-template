% !Mode:: "TeX:UTF-8"
%% 请使用 XeLaTeX 编译本文.
% \documentclass{ZUELBachelor}% 选项 forprint: 交付打印时添加, 避免彩色链接字迹打印偏淡. 即使用下一行:
 \documentclass[forprint]{ZUELBachelor}

\begin{document}
%%%%%%% 下面的内容, 据实填空.

\miji{ }                                      % 密级. 没有就空着.
\StudentNumber{201700000000} % 填写自己的学号

\title{这里是论文题目}
\Etitle{This is title of thesis} % 英文题目
\author{这里是名字}                            % 作者名字
\Eauthor{This is your name}            %作者英文名
\Csupervisor{某某\quad 副教授}        %指导教师中文名、职称
\Esupervisor{Prof.~XXX}     %指导教师英文名、职称
\Cmajor{计算机科学与技术}                  % 专业中文名
\Emajor{Computing Science and Technology}% 专业英文名
\Cschoolname{信息与安全工程学院}          % 学院名
\Eschoolname{School of Information and Safety Engineering} %学院英文名. 不确定的话, 请看一下自己学院的网页上是怎么写的. 别搞错了!
\date{二〇二〇年二月}                    % 日期, 要注意和英文日期一致!!
\Edate{February, 2020}                       % 英文封面日期
...
\begin{tabular}{ll}
\hline
   \verb|\documentclass{ZUELBachelor}|                     &  毕业论文 \\
   \verb|\documentclass[forprint]{ZUELBachelor}|        &  毕业论文打印版 \\
\hline
\end{tabular}
\end{table}
相关解释见下节.
...
\begin{tabular}{r|r|l}
	...
	\multicolumn{2}{l|}{ZUELBachelor.cls }             & 定义文档格式的 class file. 不可删除. \\ \hline\hline
\end{tabular}
\end{table}
